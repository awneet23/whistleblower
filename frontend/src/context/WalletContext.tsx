...
interface Bounty {
  ...
  rewardTokenContract: string; // Address of the reward token (e.g., USDC)
  rewardAmount: string; // Amount as string to handle BigInt conversion
  isOpen: boolean;
}
...
interface Claim {
  id: number;
  bountyId: number;
  whistleblower: string; // Address of the anonymous sender
  teaser: string;
  encryptedDataCid: string; // IPFS link
